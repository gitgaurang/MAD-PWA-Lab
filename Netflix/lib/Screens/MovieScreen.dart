...
class _MovieScreenState extends State<MovieScreen> {
 ...
 Future<void> uploadImage(String imageUrl, String imageName) async {
  try {
    ...
    if (response.statusCode == 200) {
      ...
      final File imageFile = File('${directory.path}/$imageName');
      imageFile.writeAsBytesSync(response.bodyBytes);

      // Upload the image to Firebase Storage
      final Reference storageReference = FirebaseStorage.instance.ref().child('movies/$imageName');
                  ...
                  return ListView(
                      ...
                      children: [
                        ...
                        FutureBuilder(
                          ...
                          builder: (context, AsyncSnapshot snapshot) {
                            if (snapshot.hasData) {
                              var imageUrl = "https://image.tmdb.org/t/p/original${snapshot.data!.backdropPath}";
                              var imageName = snapshot.data!.title.toString();
